...
<header class="navbar navbar-inverse" role="banner">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="index.html"><img src="<%=basePath %>plugin/bootstrap/img/logo.png"></a>
	</div>
...
<div class="content">
	...
	<div class="skins-nav">
		...
		<a href="#" class="skin second_nav" data-file="<%=basePath %>plugin/bootstrap／css/compiled/skins/dark.css">
...
<script src="<%=basePath %>plugin/bootstrap/js/jquery-ui-1.10.2.custom.min.js"></script>
<!-- knob -->
<script src="<%=basePath %>plugin/bootstrap/js/jquery.knob.js"></script>
<!-- flot charts -->
<script src="<%=basePath %>plugin/bootstrap/js/jquery.flot.js"></script>
<script src="<%=basePath %>plugin/bootstrap/js/jquery.flot.stack.js"></script>
<script src="<%=basePath %>plugin/bootstrap/js/jquery.flot.resize.js"></script>
